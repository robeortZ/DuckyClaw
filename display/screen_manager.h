 ...
 * Default transition: LV_SCR_LOAD_ANIM_OUT_LEFT.
 */
void screen_load(Screen_t *newScreen);

/**
 * @brief Load a new screen with a chosen LVGL screen transition
 * @param[in] newScreen Screen to push and show
 * @param[in] anim lv_screen_load_anim_t (e.g. LV_SCR_LOAD_ANIM_OVER_TOP for pull-down notices)
 */
